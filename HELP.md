...
* The original package name 'com.example.ai-service-proxy' is invalid and this project uses 'com.example.ai_service_proxy' instead.
...
```
$ docker run --rm -p 8080:8080 ai-service-proxy:0.0.1-SNAPSHOT
```
